# 01 — Terminologik Lug'at (o'zgarmas)

> Manba: faqat `Garri Potter kitoblari/1–7`. Har bir termin bitta tarjimaga ega va
> tarjima davomida **hech qachon o'zgarmaydi**.
>
> **Belgi:** ✅ = 7 kitobda tasdiqlangan · 🔧 = 7 kitobda yo'q, konventsiya bo'yicha
> transliteratsiya qilingan va qulflangan · ⚠️ = kitobda tasviriy/bir necha variantda,
> tarjimada birinchi uchraganda yakuniy qulflanadi.
>
> **Qoida:** tarjimada YANGI termin uchrasa — avval 7 kitobdan `grep` bilan tekshiriladi;
> topilsa aynan o'sha shakl olinadi, topilmasa konventsiya bo'yicha transliteratsiya
> qilinadi (🔧) va shu faylga qo'shiladi.

---

## 1. Bosh qahramonlar (Cursed Child)
| English | O'zbekcha (kirill) | St |
|---|---|---|
| Harry Potter | Гарри Поттер | ✅ |
| Albus Severus Potter | Альбус Северус Поттер | ✅ |
| Ginny (Potter) | Жинни (Поттер) | ✅ |
| James Potter (jr) | Жеймс Поттер | ✅ |
| Lily Potter (jr) | Лили Поттер | ✅ |
| Ron Weasley | Рон Уэсли | ✅ |
| Hermione Granger | Гермиона Грэнжер | ✅ |
| Rose Granger-Weasley | Роза Грэнжер-Уэсли | 🔧 |
| Hugo (Granger-Weasley) | Хьюго Грэнжер-Уэсли | 🔧 |
| Draco Malfoy | Драко Малфой | ✅ |
| Scorpius Malfoy | Скорпиус Малфой | 🔧 |
| Astoria (Malfoy) | Астория Малфой | 🔧 |
| Delphi / Delphini | Дельфи / Дельфини | 🔧 |
...
| Mr / Mrs / Miss | мистер / миссис / мисс | ✅ |
...
| Azkaban | Азкабан | ✅ |
| Gringotts | Гринготтс | ✅ |
| Ministry of Magic | Сеҳргарлик вазирлиги | ✅ |

## 5. Sehr / atamalar
| English | O'zbekcha | St |
|---|---|---|
| Muggle | магл | ✅ |
| wizard / witch | сеҳргар | ✅ |
| magic | сеҳр / жоду | ✅ |
| wand | сеҳрли таёқча | ✅ |
| broomstick | супурги | ✅ |
